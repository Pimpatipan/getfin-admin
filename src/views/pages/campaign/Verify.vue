          ...
          <b-col>
            ...
            >
              <template v-slot:cell(campaignName)="data">
                <span class="two-lines">{{ data.item.campaignName }}</span>
              </template>
              ...
              <template v-slot:cell(id)="data">
                <div class="d-flex justify-content-center">
                  <b-button variant="link" class="px-1 py-0">
                    <router-link
                      :to="'/campaign/verify/partnerlist/' + data.item.id"
                    >
                      ดูรายละเอียด
                    </router-link>
                  </b-button>
